...
const NavMenu = ({ lang, handleLang, menuDe, menuEn, dropDown }) => {
  ...
  return (
    <motion.div
      className={`w-1/3  max-md:w-full py-16 justify-center absolute px-10 z-40 shadow-2xl top-0 max-lg:right-0  max-md:left-0 items-start max-lg:flex hidden max-md:full_menu bg-black text-white max-md:opacity-100 ${active ? 'max-lg:bg-black text-white' : ''}`}
