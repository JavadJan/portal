...
const ContactMe = () => {
  ...
  return (
    <motion.section
      ...
      className='max-container bg-[#00152491] rounded-3xl px-[5%] flex justify-between max-sm:flex-col gap-[3%] py-10 max-lg:h-auto lg:h-[65vh]'>
      {(msgEn && msgDe) && <>

        <div className='max-lg:w-full w-[40%] bg-[#235952a4] max-lg:h-auto min-h-[80vh] h-auto  pt-6 pb-10 px-8 -mt-24 max-lg:mt-0 rounded-3xl max-sm:mb-10 relative flex flex-col justify-between max-lg:gap-6'>
