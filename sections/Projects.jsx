  ...
  return (
    <section className='max-w-[1444px] mx-auto my-auto pt-10'>
      ...
      <div className='absolute w-[100%] max-container max-lg:left-0 flex justify-center items-center max-md:gap-1 gap-4 max-md:-top-10 -top-16 z-30'>
        <div className='max-md:h-[70px] h-[120px] max-dm:w-[70px] w-[120px] project-shadow max-md:p-3 p-6 rounded-lg  flex justify-center items-center'>
          <Image src={tailwind} />
        </div>
        <div className='max-md:h-[70px] h-[120px] max-dm:w-[70px] w-[120px] project-shadow max-md:p-3 p-6 rounded-lg flex justify-center items-center'><Image src={nextjs} /></div>
        <div className='max-md:h-[70px] h-[120px] max-dm:w-[70px] w-[120px] project-shadow max-md:p-3 p-6 rounded-lg  flex justify-center items-center'><Image src={react} /></div>
        <div className='max-md:h-[70px] h-[120px] max-dm:w-[70px] w-[120px] project-shadow max-md:p-3 p-6 rounded-lg  flex justify-center items-center'><Image src={firebase} /></div>
        <div className='max-md:h-[70px] h-[120px] max-dm:w-[70px] w-[120px] project-shadow max-md:p-3 p-6 rounded-lg flex justify-center items-center'><Image src={mongodb} /></div>
      </div>

      <h1 className='max-md:justify-start justify-center max-md:text-[14px] text-2xl max-md:w-full w-[60%] max-md:mx-2 mx-auto font-sans mb-14 name'>{!lang ? "A showcase of my web development projects, demonstrating my skills in creating responsive and user-friendly websites" : "Eine Auswahl meiner Webentwicklungsprojekte, die meine Fähigkeiten in der Erstellung von responsiven und benutzerfreundlichen Websites demonstrieren."}</h1>
